        ...
        return (
            ...
            <div className="card col-md-4 col-sm-6 col-xs-12">
                ...
                <ul className="list-group list-group-flush">
                    <li className="list-group-item">User Id: <input type="text" name="userId" readOnly value={user.userId}/> </li>
                    <li className="list-group-item">Username: <input type="text" name="username" defaultValue={user.username}/></li>
                    <li className="list-group-item">Password: <input type="text" name="password" defaultValue={user.password}/></li>
                    <li className="list-group-item">First Name: <input type="text" name="firstName" defaultValue={user.firstName}/></li>
                    <li className="list-group-item">Last Name: <input type="text" name="lastName" defaultValue={user.lastName}/></li>
                    <li className="list-group-item">Email: <input type="text" name="email" defaultValue={user.email}/></li>
